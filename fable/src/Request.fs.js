...
export function findList(responseList) {
    ...
    const obj = head((matchValue = SimpleJson_tryParse(responseList), (matchValue != null) ? ((inputJson = matchValue, (typeInfo = createTypeInfo(list_type(catReturn_$reflection())), Convert_fromJson(inputJson, typeInfo)))) : (() => {
